...
public class ProjectTask extends Task {
   ...
   // transient private ArrayList<User> assignees;
    ...
    public ProjectTask(String name, String details,
                       LocalDateTime deadline,
                       String creatorUsername, int priority,
                       String projectID,
                       ArrayList<String> assigneeIDs) {
        super(name, details, deadline,
                creatorUsername, priority);
        this.projectID = projectID;
        this.assigneeIDs = assigneeIDs;
    }
